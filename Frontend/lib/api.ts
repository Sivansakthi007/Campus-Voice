...
const API_BASE_URL = (() => {
  ...
  if (typeof window === 'undefined') {
    return process.env.BACKEND_URL || "https://campus-voice-backend-qfbf.onrender.com";
  }

  // Client-side (browser) - Use NEXT_PUBLIC_ env var or production URL
  return process.env.NEXT_PUBLIC_API_URL || "https://campus-voice-backend-qfbf.onrender.com";
})();
